       ...
       <section class="panel">
         <div class="panel-body">
           ...
           <ul class="nav nav-pills nav-stacked mail-nav">
            <li><a class="" href="#"> <i class="fa fa-envelope-o"></i> All Notifications<span class="label label-info pull-right inbox-notification">8</span></a></li>
             <li><a class="" href="#"> <i class="fa fa-envelope-o"></i> Unread Notification<span class="label label-info pull-right inbox-notification">8</span></a>
               {{-- <ul class="dropdown-menu extended notification" > --}}
         {{-- <div class="notify-arrow notify-arrow-yellow"></div> --}}
         {{-- <li>
           <p class="yellow">You have 7 unread notifications</p>
         </li> --}}

       {{-- </ul> --}}
             </li>
             <li><a href="#"> <i class="fa fa-envelope-o"></i> Read Notification </a></li>
           </ul>
         </div>
       </section>
